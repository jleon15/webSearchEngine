...
public class QueryProcessor {
     ...
     */
    private static final String BASE_FILE_PATH = "./src/main/java/resources/";
    ...
    private void loadVocabularyFile() {
        try (Stream<String> stream = Files.lines(Paths.get(RESULTS_DIRECTORY + "Vocabulario.txt"))) {
            stream.forEach(line -> {
    ...
    private void loadPostingsFile() {
        try (Stream<String> stream = Files.lines(Paths.get(RESULTS_DIRECTORY + "Postings.txt"))) {
            stream.forEach(line -> {
